...
const settingsSchema = z.object({
  ...
  wordpressPublishMode: z.enum(["draft_only", "auto_publish"]).optional(),
    ...
    const settings = existing
      ...
      : await prisma.appSettings.create({
          data: {
            ...
            missionUnit: normalizedPayload.missionUnit ?? "月自然流量",
            missionDeadline: normalizedPayload.missionDeadline ?? null,
            autopilotMode: normalizedPayload.autopilotMode ?? "near_full_auto",
            wordpressPublishMode: normalizedPayload.wordpressPublishMode ?? "auto_publish",
